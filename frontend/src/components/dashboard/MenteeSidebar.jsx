    ...
    <aside className="fixed left-0 top-0 z-40 flex h-screen w-[260px] flex-col border-r border-outline-variant/20 bg-white dark:bg-surface-container-lowest">
      ...
      <div className="border-b border-outline-variant/20 p-4">
        <div className="flex flex-col items-center gap-2">
          ...
          <p className="px-1 text-center text-base font-bold leading-tight text-on-surface">
            {firstName}
          </p>
        </div>
      </div>
      ...
      <div className="mt-auto border-t border-outline-variant/20 p-4">
        <Link
          ...
          className="flex w-full items-center justify-center gap-2 rounded-lg bg-gradient-to-r from-gold-accent to-primary py-3 text-xs font-bold uppercase text-white shadow-lg shadow-primary/10"
        >
