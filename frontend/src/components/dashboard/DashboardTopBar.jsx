          ...
          {showAvatar && (
            <div className="relative">
              <button
                type="button"
                onClick={() => setOpen((v) => !v)}
                className="w-10 h-10 rounded-full overflow-hidden border border-outline-variant/25 hover:border-rose-500 transition-colors focus:outline-none focus:ring-2 focus:ring-rose-500/40"
                aria-haspopup="menu"
                aria-expanded={open}
              >
                <img
