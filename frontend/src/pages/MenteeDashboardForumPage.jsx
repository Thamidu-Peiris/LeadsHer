...
export default function MenteeDashboardForumPage() {
    ...
    <>
          ...
          <div className="flex-1 p-8">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-4 mb-8">
              ...
              <div className="bg-white dark:bg-surface-container-lowest border border-outline-variant/20 rounded-xl p-5">
                <p className="text-xs font-bold text-outline uppercase tracking-widest mb-1">Total Upvotes</p>
                <p className="font-serif-alt text-3xl font-bold text-on-surface">
                  {topics.reduce((a, t) => a + (t.upvoteCount || 0), 0)}
                </p>
              </div>
            </div>
            ...
            {loading ? (
              ...
              <div className="text-center py-20 bg-white dark:bg-surface-container-lowest border border-outline-variant/20 rounded-xl">
                ...
                <p className="text-outline text-sm mb-6">Start your first discussion and engage with the community.</p>
