...
export FORUM_SERVICE_HOST="${FORUM_SERVICE_HOST:-forum-service}"
export FORUM_SERVICE_PORT="${FORUM_SERVICE_PORT:-5005}"
export PORT="${PORT:-5000}"

envsubst '${AUTH_SERVICE_HOST} ${AUTH_SERVICE_PORT} ${STORY_SERVICE_HOST} ${STORY_SERVICE_PORT} ${MENTORSHIP_SERVICE_HOST} ${MENTORSHIP_SERVICE_PORT} ${RESOURCE_SERVICE_HOST} ${RESOURCE_SERVICE_PORT} ${EVENT_SERVICE_HOST} ${EVENT_SERVICE_PORT} ${FORUM_SERVICE_HOST} ${FORUM_SERVICE_PORT} ${PORT}' \
