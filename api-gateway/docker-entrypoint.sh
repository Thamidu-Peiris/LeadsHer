...
envsubst '${AUTH_SERVICE_HOST} ${AUTH_SERVICE_PORT} ${STORY_SERVICE_HOST} ${STORY_SERVICE_PORT} ${MENTORSHIP_SERVICE_HOST} ${MENTORSHIP_SERVICE_PORT} ${RESOURCE_SERVICE_HOST} ${RESOURCE_SERVICE_PORT} ${PORT}' \
